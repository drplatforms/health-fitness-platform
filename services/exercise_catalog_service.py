...
EXERCISE_CATALOG_EXPANSION_V2_BATCH_1: list[ExerciseCatalogEntry] = [
    ExerciseCatalogEntry(
        None,
        "Archer Push-Up",
        "strength",
    ...
    ExerciseCatalogEntry(
        ...
        "horizontal_pull",
        ["upper_back", "lats", "biceps"],
        ["resistance_band", "adjustable_bench"],
        "beginner",
    ),
    ExerciseCatalogEntry(
        None,
...
CURATED_EXERCISE_CATALOG.extend(EXERCISE_CATALOG_EXPANSION_V2_BATCH_1)
...
def _validated_prescription_measurement_seed_metadata(
    ...
    if (
        default_counts != {"reps": 263, "duration": 29, "distance": 8}
