# ADR: Training Evidence Claim Service
...
Training provider voice requires exact anchors, approved training claims, and strict validation before public rendering.
