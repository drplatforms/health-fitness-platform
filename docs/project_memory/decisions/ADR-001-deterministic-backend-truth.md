# ADR: Deterministic Backend Truth
...
Backend-owned deterministic logic is the public-safe baseline for calculations, decisions, fallback copy, validation, and persistence.
