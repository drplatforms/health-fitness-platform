# ADR: Full Report Composition Boundary
...
Coordinator failure must not discard approved provider-backed sections; deterministic fallback composition must preserve safe content.
