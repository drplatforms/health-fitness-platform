# ADR: Provider-Integrated Training Only v1
...
Training is the only provider-integrated full-report section; non-training sections remain deterministic/current-state until their own boundaries mature.
