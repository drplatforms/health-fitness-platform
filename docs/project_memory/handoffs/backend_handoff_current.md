...
Implement scoped services/routes/tests without broadening provider, persistence, schema, nutrition, workout, catalog, or report behavior beyond the milestone.
