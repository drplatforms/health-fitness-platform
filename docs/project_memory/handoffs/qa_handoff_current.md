...
Validate deterministic fallback, provider boundaries, Streamlit behavior, report persistence, workout lifecycle, catalog regressions, and project-memory accuracy.
